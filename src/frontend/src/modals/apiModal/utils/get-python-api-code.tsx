...
try:
    ...
    warnings.warn("Automation Builder provides a function to help you upload files to the flow. Please install langflow to use it.")
    upload_file = None
...
def main():
    ...
    if args.upload_file:
        if not upload_file:
            raise ImportError("Automation Builder is not installed. Please install it to use the upload_file function.")
