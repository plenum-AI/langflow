...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the Automation Builder documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "Automation Builder: Create, Chain, Communicate.",
  ...
  "Design Dialogues with Automation Builder.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Automation Builder API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Automation Builder Chat";
...
export const STORE_TITLE = "Automation Builder Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Automation Builder API key.";
